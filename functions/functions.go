...
func (srv *Functions) WithCreateProviderBranches(v []string) CreateOption {
	return func(o *CreateOptions) {
		o.ProviderBranches = v
		o.enabledSetters["ProviderBranches"] = true
	}
}
func (srv *Functions) WithCreateProviderPaths(v []string) CreateOption {
	return func(o *CreateOptions) {
		o.ProviderPaths = v
...
func (srv *Functions) WithUpdateProviderBranches(v []string) UpdateOption {
	return func(o *UpdateOptions) {
		o.ProviderBranches = v
		o.enabledSetters["ProviderBranches"] = true
	}
}
func (srv *Functions) WithUpdateProviderPaths(v []string) UpdateOption {
	return func(o *UpdateOptions) {
		o.ProviderPaths = v
		o.enabledSetters["ProviderPaths"] = true
	}
...
func (options CreateDeploymentOptions) New() *CreateDeploymentOptions {
	options.enabledSetters = map[string]bool{"Entrypoint": false, "Commands": false}
	return &options
}
...
func (options CreateDuplicateDeploymentOptions) New() *CreateDuplicateDeploymentOptions {
	options.enabledSetters = map[string]bool{"BuildId": false}
	return &options
}
...
func (srv *Functions) WithGetDeploymentDownloadToken(v string) GetDeploymentDownloadOption {
	return func(o *GetDeploymentDownloadOptions) {
		o.Token = v
...
func (options CreateExecutionOptions) New() *CreateExecutionOptions {
	options.enabledSetters = map[string]bool{"Body": false, "Async": false, "Path": false, "Method": false, "Headers": false, "ScheduledAt": false}
	return &options
}
