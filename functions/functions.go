...
func (srv *Functions) Create(FunctionId string, Name string, Runtime string, optionalSetters ...CreateOption)(*models.Function, error) {
	...
	if options.enabledSetters["TemplateBranch"] {
		params["templateBranch"] = options.TemplateBranch
	}
	headers := map[string]interface{}{
		"content-type": "application/json",
	}
...
// DownloadDeployment get a Deployment's contents by its unique ID. This
