...
func TestOAuth2MicrosoftModel(t *testing.T) {
    model := OAuth2Microsoft{        Id: "github",        Enabled: true,        ApplicationId: "00001111-aaaa-2222-bbbb-3333cccc4444",        ApplicationSecret: "your-oauth2-client-secret",        Tenant: "common",    }
