...
func TestDedicatedDatabaseModel(t *testing.T) {
    ...
    if result.CrossRegionReplicas != model.CrossRegionReplicas {
        t.Errorf("Expected CrossRegionReplicas %v, got %v", model.CrossRegionReplicas, result.CrossRegionReplicas)
    }
