...
func TestAttributeObjectModel(t *testing.T) {
	model := AttributeObject{Key: "fullName", Type: "string", Status: "available", Error: "string", Required: true, CreatedAt: "2020-10-15T06:38:00.000+00:00", UpdatedAt: "2020-10-15T06:38:00.000+00:00"}
