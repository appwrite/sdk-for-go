...
func TestProjectModel(t *testing.T) {
    ...
    if result.AuthMembershipsUserId != model.AuthMembershipsUserId {
        t.Errorf("Expected AuthMembershipsUserId %v, got %v", model.AuthMembershipsUserId, result.AuthMembershipsUserId)
    }
    if result.AuthMembershipsUserPhone != model.AuthMembershipsUserPhone {
        t.Errorf("Expected AuthMembershipsUserPhone %v, got %v", model.AuthMembershipsUserPhone, result.AuthMembershipsUserPhone)
    }
