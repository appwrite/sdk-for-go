...
func TestProjectModel(t *testing.T) {
	...
	if result.WafEnabled != model.WafEnabled {
		t.Errorf("Expected WafEnabled %v, got %v", model.WafEnabled, result.WafEnabled)
	}
}
