...
func TestOAuth2GitlabModel(t *testing.T) {
    model := OAuth2Gitlab{        Id: "github",        Enabled: true,        ApplicationId: "d41ffe0000000000000000000000000000000000000000000000000000d5e252",        Secret: "your-oauth2-client-secret",        Endpoint: "https://gitlab.com",    }
