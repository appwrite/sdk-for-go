...
func TestOAuth2Auth0Model(t *testing.T) {
    model := OAuth2Auth0{        Id: "github",        Enabled: true,        ClientId: "OaOkIA000000000000000000005KLSYq",        ClientSecret: "your-oauth2-client-secret",        Endpoint: "example.us.auth0.com",    }
