...
func TestOauth2ConsentTokenModel(t *testing.T) {
    ...
    if result.ConsentId != model.ConsentId {
        t.Errorf("Expected ConsentId %v, got %v", model.ConsentId, result.ConsentId)
    }
