...
func TestBillingPlanModel(t *testing.T) {
    ...
    if result.Members != model.Members {
        t.Errorf("Expected Members %v, got %v", model.Members, result.Members)
    }
    ...
    if result.ActivityLogs != model.ActivityLogs {
        t.Errorf("Expected ActivityLogs %v, got %v", model.ActivityLogs, result.ActivityLogs)
    }
    ...
    if result.BackupsEnabled != model.BackupsEnabled {
        t.Errorf("Expected BackupsEnabled %v, got %v", model.BackupsEnabled, result.BackupsEnabled)
    }
    ...
    if result.BackupPolicies != model.BackupPolicies {
        t.Errorf("Expected BackupPolicies %v, got %v", model.BackupPolicies, result.BackupPolicies)
    }
