...
func TestOAuth2FusionAuthModel(t *testing.T) {
    model := OAuth2FusionAuth{        Id: "github",        Enabled: true,        ClientId: "b2222c00-0000-0000-0000-000000862097",        ClientSecret: "your-oauth2-client-secret",        Endpoint: "example.fusionauth.io",    }
