...
func TestAttributeEnumModel(t *testing.T) {
    model := AttributeEnum{        Key: "status",        Type: "string",        Status: "available",        Error: "string",        Required: true,        CreatedAt: "2020-10-15T06:38:00.000+00:00",        UpdatedAt: "2020-10-15T06:38:00.000+00:00",        Elements: []string{"test"},        Format: "enum",    }
    ...
    if result.Format != model.Format {
        t.Errorf("Expected Format %v, got %v", model.Format, result.Format)
    }}
