...
func TestOAuth2KeycloakModel(t *testing.T) {
    model := OAuth2Keycloak{        Id: "github",        Enabled: true,        ClientId: "appwrite-o0000000st-app",        ClientSecret: "your-oauth2-client-secret",        Endpoint: "keycloak.example.com",        RealmName: "appwrite-realm",    }
