...
func TestOAuth2OktaModel(t *testing.T) {
    model := OAuth2Okta{        Id: "github",        Enabled: true,        ClientId: "0oa00000000000000698",        ClientSecret: "your-oauth2-client-secret",        Domain: "trial-6400025.okta.com",        AuthorizationServerId: "aus000000000000000h7z",    }
