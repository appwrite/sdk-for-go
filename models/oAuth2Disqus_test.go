...
func TestOAuth2DisqusModel(t *testing.T) {
    model := OAuth2Disqus{        Id: "github",        Enabled: true,        PublicKey: "cgegH70000000000000000000000000000000000000000000000000000Hr1nYX",        SecretKey: "your-oauth2-client-secret",    }
