...
func TestOAuth2AuthentikModel(t *testing.T) {
    model := OAuth2Authentik{        Id: "github",        Enabled: true,        ClientId: "dTKOPa0000000000000000000000000000e7G8hv",        ClientSecret: "your-oauth2-client-secret",        Endpoint: "example.authentik.com",    }
