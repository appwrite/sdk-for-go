...
func (options CreateOptions) New() *CreateOptions {
	options.enabledSetters = map[string]bool{"Description": false, "ClientUri": false, "LogoUri": false, "PrivacyPolicyUrl": false, "TermsUrl": false, "Contacts": false, "Tagline": false, "Tags": false, "Images": false, "SupportUrl": false, "DataDeletionUrl": false, "PostLogoutRedirectUris": false, "Enabled": false, "Type": false, "DeviceFlow": false, "TeamId": false}
	return &options
}
...
func (options UpdateOptions) New() *UpdateOptions {
	options.enabledSetters = map[string]bool{"Description": false, "ClientUri": false, "LogoUri": false, "PrivacyPolicyUrl": false, "TermsUrl": false, "Contacts": false, "Tagline": false, "Tags": false, "Images": false, "SupportUrl": false, "DataDeletionUrl": false, "Enabled": false, "RedirectUris": false, "PostLogoutRedirectUris": false, "Type": false, "DeviceFlow": false, "InstallationScopes": false, "InstallationRedirectUrl": false}
	return &options
}
