...
func New(clt client.Client) *Tables {
	return &Tables{
		client: clt,
	}
}
...
func (srv *Tables) WithListQueries(v []string) ListOption {
	return func(o *ListOptions) {
		o.Queries = v
		o.enabledSetters["Queries"] = true
	}
}
func (srv *Tables) WithListSearch(v string) ListOption {
	return func(o *ListOptions) {
		o.Search = v
...
// List get a list of all tables that belong to the provided databaseId. You
// can use the search parameter to filter your results.
func (srv *Tables) List(DatabaseId string, optionalSetters ...ListOption)(*models.TableList, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId)
	path := r.Replace("/databases/{databaseId}/tables")
...
func (srv *Tables) WithCreatePermissions(v []string) CreateOption {
	return func(o *CreateOptions) {
		o.Permissions = v
		o.enabledSetters["Permissions"] = true
	}
}
func (srv *Tables) WithCreateRowSecurity(v bool) CreateOption {
	return func(o *CreateOptions) {
		o.RowSecurity = v
		o.enabledSetters["RowSecurity"] = true
	}
}
func (srv *Tables) WithCreateEnabled(v bool) CreateOption {
	return func(o *CreateOptions) {
		o.Enabled = v
...
// Create create a new Table. Before using this route, you should create a new
// database resource using either a [server
// integration](https://appwrite.io/docs/server/databases#databasesCreateTable)
// API or directly from your database console.
func (srv *Tables) Create(DatabaseId string, TableId string, Name string, optionalSetters ...CreateOption)(*models.Table, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId)
	path := r.Replace("/databases/{databaseId}/tables")
...
// Get get a table by its unique ID. This endpoint response returns a JSON
// object with the table metadata.
func (srv *Tables) Get(DatabaseId string, TableId string)(*models.Table, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}")
	params := map[string]interface{}{}
	params["databaseId"] = DatabaseId
	params["tableId"] = TableId
	headers := map[string]interface{}{
...
func (srv *Tables) WithUpdatePermissions(v []string) UpdateOption {
	return func(o *UpdateOptions) {
		o.Permissions = v
		o.enabledSetters["Permissions"] = true
	}
}
func (srv *Tables) WithUpdateRowSecurity(v bool) UpdateOption {
	return func(o *UpdateOptions) {
		o.RowSecurity = v
		o.enabledSetters["RowSecurity"] = true
	}
}
func (srv *Tables) WithUpdateEnabled(v bool) UpdateOption {
	return func(o *UpdateOptions) {
		o.Enabled = v
		o.enabledSetters["Enabled"] = true
	}
...
// Update update a table by its unique ID.
func (srv *Tables) Update(DatabaseId string, TableId string, Name string, optionalSetters ...UpdateOption)(*models.Table, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}")
...
// Delete delete a table by its unique ID. Only users with write permissions
// have access to delete this resource.
func (srv *Tables) Delete(DatabaseId string, TableId string)(*interface{}, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}")
	params := map[string]interface{}{}
	params["databaseId"] = DatabaseId
...
func (srv *Tables) WithListColumnsQueries(v []string) ListColumnsOption {
...
// ListColumns list attributes in the collection.
func (srv *Tables) ListColumns(DatabaseId string, TableId string, optionalSetters ...ListColumnsOption)(*models.ColumnList, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns")
...
func (srv *Tables) WithCreateBooleanColumnDefault(v bool) CreateBooleanColumnOption {
	return func(o *CreateBooleanColumnOptions) {
		o.Default = v
		o.enabledSetters["Default"] = true
	}
}
func (srv *Tables) WithCreateBooleanColumnArray(v bool) CreateBooleanColumnOption {
	return func(o *CreateBooleanColumnOptions) {
		o.Array = v
...
func (srv *Tables) CreateBooleanColumn(DatabaseId string, TableId string, Key string, Required bool, optionalSetters ...CreateBooleanColumnOption)(*models.ColumnBoolean, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/boolean")
...
func (srv *Tables) WithUpdateBooleanColumnNewKey(v string) UpdateBooleanColumnOption {
...
func (srv *Tables) UpdateBooleanColumn(DatabaseId string, TableId string, Key string, Required bool, Default bool, optionalSetters ...UpdateBooleanColumnOption)(*models.ColumnBoolean, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{key}", Key)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/boolean/{key}")
...
func (srv *Tables) WithCreateDatetimeColumnDefault(v string) CreateDatetimeColumnOption {
	return func(o *CreateDatetimeColumnOptions) {
		o.Default = v
		o.enabledSetters["Default"] = true
	}
}
func (srv *Tables) WithCreateDatetimeColumnArray(v bool) CreateDatetimeColumnOption {
	return func(o *CreateDatetimeColumnOptions) {
		o.Array = v
		o.enabledSetters["Array"] = true
	}
...
// standard.
func (srv *Tables) CreateDatetimeColumn(DatabaseId string, TableId string, Key string, Required bool, optionalSetters ...CreateDatetimeColumnOption)(*models.ColumnDatetime, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/datetime")
...
func (srv *Tables) WithUpdateDatetimeColumnNewKey(v string) UpdateDatetimeColumnOption {
...
func (srv *Tables) UpdateDatetimeColumn(DatabaseId string, TableId string, Key string, Required bool, Default string, optionalSetters ...UpdateDatetimeColumnOption)(*models.ColumnDatetime, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{key}", Key)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/datetime/{key}")
...
func (srv *Tables) WithCreateEmailColumnDefault(v string) CreateEmailColumnOption {
	return func(o *CreateEmailColumnOptions) {
		o.Default = v
		o.enabledSetters["Default"] = true
	}
}
func (srv *Tables) WithCreateEmailColumnArray(v bool) CreateEmailColumnOption {
	return func(o *CreateEmailColumnOptions) {
		o.Array = v
		o.enabledSetters["Array"] = true
	}
...
func (srv *Tables) CreateEmailColumn(DatabaseId string, TableId string, Key string, Required bool, optionalSetters ...CreateEmailColumnOption)(*models.ColumnEmail, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/email")
...
func (srv *Tables) WithUpdateEmailColumnNewKey(v string) UpdateEmailColumnOption {
...
func (srv *Tables) UpdateEmailColumn(DatabaseId string, TableId string, Key string, Required bool, Default string, optionalSetters ...UpdateEmailColumnOption)(*models.ColumnEmail, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{key}", Key)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/email/{key}")
...
func (srv *Tables) WithCreateEnumColumnDefault(v string) CreateEnumColumnOption {
	return func(o *CreateEnumColumnOptions) {
		o.Default = v
		o.enabledSetters["Default"] = true
	}
}
func (srv *Tables) WithCreateEnumColumnArray(v bool) CreateEnumColumnOption {
	return func(o *CreateEnumColumnOptions) {
		o.Array = v
		o.enabledSetters["Array"] = true
	}
...
func (srv *Tables) CreateEnumColumn(DatabaseId string, TableId string, Key string, Elements []string, Required bool, optionalSetters ...CreateEnumColumnOption)(*models.ColumnEnum, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/enum")
...
func (srv *Tables) WithUpdateEnumColumnNewKey(v string) UpdateEnumColumnOption {
...
// not update already existing rows.
func (srv *Tables) UpdateEnumColumn(DatabaseId string, TableId string, Key string, Elements []string, Required bool, Default string, optionalSetters ...UpdateEnumColumnOption)(*models.ColumnEnum, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{key}", Key)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/enum/{key}")
...
func (srv *Tables) WithCreateFloatColumnMin(v float64) CreateFloatColumnOption {
	return func(o *CreateFloatColumnOptions) {
		o.Min = v
		o.enabledSetters["Min"] = true
	}
}
func (srv *Tables) WithCreateFloatColumnMax(v float64) CreateFloatColumnOption {
	return func(o *CreateFloatColumnOptions) {
		o.Max = v
		o.enabledSetters["Max"] = true
	}
}
func (srv *Tables) WithCreateFloatColumnDefault(v float64) CreateFloatColumnOption {
	return func(o *CreateFloatColumnOptions) {
		o.Default = v
		o.enabledSetters["Default"] = true
	}
}
func (srv *Tables) WithCreateFloatColumnArray(v bool) CreateFloatColumnOption {
	return func(o *CreateFloatColumnOptions) {
		o.Array = v
		o.enabledSetters["Array"] = true
	}
...
func (srv *Tables) CreateFloatColumn(DatabaseId string, TableId string, Key string, Required bool, optionalSetters ...CreateFloatColumnOption)(*models.ColumnFloat, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/float")
...
func (srv *Tables) WithUpdateFloatColumnMin(v float64) UpdateFloatColumnOption {
	return func(o *UpdateFloatColumnOptions) {
		o.Min = v
		o.enabledSetters["Min"] = true
	}
}
func (srv *Tables) WithUpdateFloatColumnMax(v float64) UpdateFloatColumnOption {
	return func(o *UpdateFloatColumnOptions) {
		o.Max = v
		o.enabledSetters["Max"] = true
	}
}
func (srv *Tables) WithUpdateFloatColumnNewKey(v string) UpdateFloatColumnOption {
	return func(o *UpdateFloatColumnOptions) {
		o.NewKey = v
		o.enabledSetters["NewKey"] = true
	}
...
// not update already existing rows.
func (srv *Tables) UpdateFloatColumn(DatabaseId string, TableId string, Key string, Required bool, Default float64, optionalSetters ...UpdateFloatColumnOption)(*models.ColumnFloat, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{key}", Key)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/float/{key}")
...
func (srv *Tables) WithCreateIntegerColumnMax(v int) CreateIntegerColumnOption {
	return func(o *CreateIntegerColumnOptions) {
		o.Max = v
		o.enabledSetters["Max"] = true
	}
}
func (srv *Tables) WithCreateIntegerColumnDefault(v int) CreateIntegerColumnOption {
	return func(o *CreateIntegerColumnOptions) {
		o.Default = v
		o.enabledSetters["Default"] = true
	}
}
func (srv *Tables) WithCreateIntegerColumnArray(v bool) CreateIntegerColumnOption {
	return func(o *CreateIntegerColumnOptions) {
		o.Array = v
		o.enabledSetters["Array"] = true
	}
...
func (srv *Tables) CreateIntegerColumn(DatabaseId string, TableId string, Key string, Required bool, optionalSetters ...CreateIntegerColumnOption)(*models.ColumnInteger, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/integer")
...
func (srv *Tables) WithUpdateIntegerColumnMin(v int) UpdateIntegerColumnOption {
	return func(o *UpdateIntegerColumnOptions) {
		o.Min = v
		o.enabledSetters["Min"] = true
	}
}
func (srv *Tables) WithUpdateIntegerColumnMax(v int) UpdateIntegerColumnOption {
	return func(o *UpdateIntegerColumnOptions) {
		o.Max = v
		o.enabledSetters["Max"] = true
	}
}
func (srv *Tables) WithUpdateIntegerColumnNewKey(v string) UpdateIntegerColumnOption {
	return func(o *UpdateIntegerColumnOptions) {
		o.NewKey = v
		o.enabledSetters["NewKey"] = true
	}
...
// will not update already existing rows.
func (srv *Tables) UpdateIntegerColumn(DatabaseId string, TableId string, Key string, Required bool, Default int, optionalSetters ...UpdateIntegerColumnOption)(*models.ColumnInteger, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{key}", Key)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/integer/{key}")
...
func (srv *Tables) WithCreateIpColumnDefault(v string) CreateIpColumnOption {
	return func(o *CreateIpColumnOptions) {
		o.Default = v
		o.enabledSetters["Default"] = true
	}
}
func (srv *Tables) WithCreateIpColumnArray(v bool) CreateIpColumnOption {
	return func(o *CreateIpColumnOptions) {
		o.Array = v
		o.enabledSetters["Array"] = true
	}
...
func (srv *Tables) CreateIpColumn(DatabaseId string, TableId string, Key string, Required bool, optionalSetters ...CreateIpColumnOption)(*models.ColumnIp, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/ip")
...
func (srv *Tables) WithUpdateIpColumnNewKey(v string) UpdateIpColumnOption {
...
func (srv *Tables) UpdateIpColumn(DatabaseId string, TableId string, Key string, Required bool, Default string, optionalSetters ...UpdateIpColumnOption)(*models.ColumnIp, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{key}", Key)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/ip/{key}")
...
func (srv *Tables) WithCreateRelationshipColumnTwoWay(v bool) CreateRelationshipColumnOption {
	return func(o *CreateRelationshipColumnOptions) {
		o.TwoWay = v
		o.enabledSetters["TwoWay"] = true
	}
}
func (srv *Tables) WithCreateRelationshipColumnKey(v string) CreateRelationshipColumnOption {
	return func(o *CreateRelationshipColumnOptions) {
		o.Key = v
		o.enabledSetters["Key"] = true
	}
}
func (srv *Tables) WithCreateRelationshipColumnTwoWayKey(v string) CreateRelationshipColumnOption {
	return func(o *CreateRelationshipColumnOptions) {
		o.TwoWayKey = v
		o.enabledSetters["TwoWayKey"] = true
	}
}
func (srv *Tables) WithCreateRelationshipColumnOnDelete(v string) CreateRelationshipColumnOption {
	return func(o *CreateRelationshipColumnOptions) {
		o.OnDelete = v
...
func (srv *Tables) CreateRelationshipColumn(DatabaseId string, TableId string, RelatedTableId string, Type string, optionalSetters ...CreateRelationshipColumnOption)(*models.ColumnRelationship, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/relationship")
...
func (srv *Tables) WithCreateStringColumnArray(v bool) CreateStringColumnOption {
	return func(o *CreateStringColumnOptions) {
		o.Array = v
		o.enabledSetters["Array"] = true
	}
}
func (srv *Tables) WithCreateStringColumnEncrypt(v bool) CreateStringColumnOption {
	return func(o *CreateStringColumnOptions) {
		o.Encrypt = v
...
func (srv *Tables) CreateStringColumn(DatabaseId string, TableId string, Key string, Size int, Required bool, optionalSetters ...CreateStringColumnOption)(*models.ColumnString, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/string")
...
func (srv *Tables) WithUpdateStringColumnSize(v int) UpdateStringColumnOption {
	return func(o *UpdateStringColumnOptions) {
		o.Size = v
		o.enabledSetters["Size"] = true
	}
}
func (srv *Tables) WithUpdateStringColumnNewKey(v string) UpdateStringColumnOption {
	return func(o *UpdateStringColumnOptions) {
		o.NewKey = v
		o.enabledSetters["NewKey"] = true
	}
...
// will not update already existing rows.
func (srv *Tables) UpdateStringColumn(DatabaseId string, TableId string, Key string, Required bool, Default string, optionalSetters ...UpdateStringColumnOption)(*models.ColumnString, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{key}", Key)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/string/{key}")
...
func (srv *Tables) WithCreateUrlColumnDefault(v string) CreateUrlColumnOption {
	return func(o *CreateUrlColumnOptions) {
		o.Default = v
		o.enabledSetters["Default"] = true
	}
}
func (srv *Tables) WithCreateUrlColumnArray(v bool) CreateUrlColumnOption {
	return func(o *CreateUrlColumnOptions) {
		o.Array = v
		o.enabledSetters["Array"] = true
	}
...
func (srv *Tables) CreateUrlColumn(DatabaseId string, TableId string, Key string, Required bool, optionalSetters ...CreateUrlColumnOption)(*models.ColumnUrl, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/url")
...
func (srv *Tables) WithUpdateUrlColumnNewKey(v string) UpdateUrlColumnOption {
...
// update already existing rows.
func (srv *Tables) UpdateUrlColumn(DatabaseId string, TableId string, Key string, Required bool, Default string, optionalSetters ...UpdateUrlColumnOption)(*models.ColumnUrl, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{key}", Key)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/url/{key}")
...
func (srv *Tables) GetColumn(DatabaseId string, TableId string, Key string)(*interface{}, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{key}", Key)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/{key}")
	params := map[string]interface{}{}
	params["databaseId"] = DatabaseId
	params["tableId"] = TableId
	params["key"] = Key
...
func (srv *Tables) DeleteColumn(DatabaseId string, TableId string, Key string)(*interface{}, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{key}", Key)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/{key}")
	params := map[string]interface{}{}
	params["databaseId"] = DatabaseId
...
func (srv *Tables) WithUpdateRelationshipColumnOnDelete(v string) UpdateRelationshipColumnOption {
	return func(o *UpdateRelationshipColumnOptions) {
		o.OnDelete = v
		o.enabledSetters["OnDelete"] = true
	}
}
func (srv *Tables) WithUpdateRelationshipColumnNewKey(v string) UpdateRelationshipColumnOption {
	return func(o *UpdateRelationshipColumnOptions) {
		o.NewKey = v
		o.enabledSetters["NewKey"] = true
	}
...
// relationship
// columns](https://appwrite.io/docs/databases-relationships#relationship-columns).
func (srv *Tables) UpdateRelationshipColumn(DatabaseId string, TableId string, Key string, optionalSetters ...UpdateRelationshipColumnOption)(*models.ColumnRelationship, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{key}", Key)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/columns/{key}/relationship")
...
func (srv *Tables) WithListIndexesQueries(v []string) ListIndexesOption {
...
func (srv *Tables) ListIndexes(DatabaseId string, TableId string, optionalSetters ...ListIndexesOption)(*models.ColumnIndexList, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/indexes")
...
func (srv *Tables) WithCreateIndexOrders(v []string) CreateIndexOption {
	return func(o *CreateIndexOptions) {
		o.Orders = v
		o.enabledSetters["Orders"] = true
	}
}
func (srv *Tables) WithCreateIndexLengths(v []int) CreateIndexOption {
	return func(o *CreateIndexOptions) {
		o.Lengths = v
...
func (srv *Tables) CreateIndex(DatabaseId string, TableId string, Key string, Type string, Columns []string, optionalSetters ...CreateIndexOption)(*models.ColumnIndex, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/indexes")
...
func (srv *Tables) GetIndex(DatabaseId string, TableId string, Key string)(*models.ColumnIndex, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{key}", Key)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/indexes/{key}")
	params := map[string]interface{}{}
	params["databaseId"] = DatabaseId
	params["tableId"] = TableId
	params["key"] = Key
...
func (srv *Tables) DeleteIndex(DatabaseId string, TableId string, Key string)(*interface{}, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{key}", Key)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/indexes/{key}")
	params := map[string]interface{}{}
	params["databaseId"] = DatabaseId
...
func (srv *Tables) WithListRowsQueries(v []string) ListRowsOption {
...
func (srv *Tables) ListRows(DatabaseId string, TableId string, optionalSetters ...ListRowsOption)(*models.RowList, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/rows")
...
func (srv *Tables) WithCreateRowPermissions(v []string) CreateRowOption {
...
// integration](https://appwrite.io/docs/server/databases#databasesCreateTable)
// API or directly from your database console.
func (srv *Tables) CreateRow(DatabaseId string, TableId string, RowId string, Data interface{}, optionalSetters ...CreateRowOption)(*models.Row, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/rows")
...
// integration](https://appwrite.io/docs/server/databases#databasesCreateTable)
// API or directly from your database console.
func (srv *Tables) CreateRows(DatabaseId string, TableId string, Rows []interface{})(*models.RowList, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/rows")
	params := map[string]interface{}{}
	params["databaseId"] = DatabaseId
...
// integration](https://appwrite.io/docs/server/databases#databasesCreateTable)
// API or directly from your database console.
func (srv *Tables) UpsertRows(DatabaseId string, TableId string)(*models.RowList, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/rows")
	params := map[string]interface{}{}
	params["databaseId"] = DatabaseId
...
func (srv *Tables) WithUpdateRowsData(v interface{}) UpdateRowsOption {
	return func(o *UpdateRowsOptions) {
		o.Data = v
		o.enabledSetters["Data"] = true
	}
}
func (srv *Tables) WithUpdateRowsQueries(v []string) UpdateRowsOption {
	return func(o *UpdateRowsOptions) {
		o.Queries = v
		o.enabledSetters["Queries"] = true
	}
...
// be updated.
func (srv *Tables) UpdateRows(DatabaseId string, TableId string, optionalSetters ...UpdateRowsOption)(*models.RowList, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/rows")
...
func (srv *Tables) WithDeleteRowsQueries(v []string) DeleteRowsOption {
...
func (srv *Tables) DeleteRows(DatabaseId string, TableId string, optionalSetters ...DeleteRowsOption)(*models.RowList, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/rows")
...
func (srv *Tables) WithGetRowQueries(v []string) GetRowOption {
...
func (srv *Tables) GetRow(DatabaseId string, TableId string, RowId string, optionalSetters ...GetRowOption)(*models.Row, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{rowId}", RowId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/rows/{rowId}")
...
// integration](https://appwrite.io/docs/server/databases#databasesCreateTable)
// API or directly from your database console.
func (srv *Tables) UpsertRow(DatabaseId string, TableId string, RowId string)(*models.Row, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{rowId}", RowId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/rows/{rowId}")
	params := map[string]interface{}{}
	params["databaseId"] = DatabaseId
...
func (srv *Tables) WithUpdateRowData(v interface{}) UpdateRowOption {
	return func(o *UpdateRowOptions) {
		o.Data = v
		o.enabledSetters["Data"] = true
	}
}
func (srv *Tables) WithUpdateRowPermissions(v []string) UpdateRowOption {
	return func(o *UpdateRowOptions) {
		o.Permissions = v
		o.enabledSetters["Permissions"] = true
	}
...
func (srv *Tables) UpdateRow(DatabaseId string, TableId string, RowId string, optionalSetters ...UpdateRowOption)(*models.Row, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{rowId}", RowId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/rows/{rowId}")
...
func (srv *Tables) DeleteRow(DatabaseId string, TableId string, RowId string)(*interface{}, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{rowId}", RowId)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/rows/{rowId}")
	params := map[string]interface{}{}
	params["databaseId"] = DatabaseId
...
func (srv *Tables) WithDecrementRowColumnValue(v float64) DecrementRowColumnOption {
	return func(o *DecrementRowColumnOptions) {
		o.Value = v
		o.enabledSetters["Value"] = true
	}
}
func (srv *Tables) WithDecrementRowColumnMin(v float64) DecrementRowColumnOption {
	return func(o *DecrementRowColumnOptions) {
		o.Min = v
		o.enabledSetters["Min"] = true
	}
...
func (srv *Tables) DecrementRowColumn(DatabaseId string, TableId string, RowId string, Column string, optionalSetters ...DecrementRowColumnOption)(*models.Row, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{rowId}", RowId, "{column}", Column)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/rows/{rowId}/{column}/decrement")
...
func (srv *Tables) WithIncrementRowColumnValue(v float64) IncrementRowColumnOption {
	return func(o *IncrementRowColumnOptions) {
		o.Value = v
		o.enabledSetters["Value"] = true
	}
}
func (srv *Tables) WithIncrementRowColumnMax(v float64) IncrementRowColumnOption {
	return func(o *IncrementRowColumnOptions) {
		o.Max = v
		o.enabledSetters["Max"] = true
	}
...
func (srv *Tables) IncrementRowColumn(DatabaseId string, TableId string, RowId string, Column string, optionalSetters ...IncrementRowColumnOption)(*models.Row, error) {
	r := strings.NewReplacer("{databaseId}", DatabaseId, "{tableId}", TableId, "{rowId}", RowId, "{column}", Column)
	path := r.Replace("/databases/{databaseId}/tables/{tableId}/rows/{rowId}/{column}/increment")
